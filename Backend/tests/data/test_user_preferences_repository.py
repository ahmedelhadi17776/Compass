...
from Backend.data.repositories.user_preferences_repository import UserPreferencesRepository
from Backend.data.database.models.user_preferences import UserPreferences
