"""init schema after task managment factor

Revision ID: 648aa1f1f228
Revises: 
Create Date: 2025-03-12 21:47:48.555306+00:00
...
def upgrade() -> None:
    ...
    sa.Column('progress_metrics', sa.JSON(), server_default=sa.text("json('{}')"), nullable=False),
    sa.Column('blockers', sa.JSON(), server_default=sa.text("json('[]')"), nullable=False),
    ...
    op.create_index('ix_task_status_updated_at', 'tasks', ['status_updated_at'], unique=False)
    ...
    op.create_index('ix_calendar_events_recurrence', 'calendar_events', ['recurrence'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_calendar_events_recurrence', table_name='calendar_events')
    ...
    op.drop_index('ix_task_status_updated_at', table_name='tasks')
