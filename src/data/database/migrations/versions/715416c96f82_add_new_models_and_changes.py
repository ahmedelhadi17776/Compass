...
Revision ID: 715416c96f82
Revises: 
Create Date: 2024-12-10 13:10:29.455465
...
def upgrade() -> None:
    ...
    op.create_index('ix_users_status', 'User', ['status'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['parent_id'], ['task_categories.id'], name=op.f('fi k_task_categories_parent_id_task_categories')),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_auth_log_user_id', ondelete='SET NULL'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_cache_user_id'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_data_request_user_id', ondelete='CASCADE'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_device_control_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_emotional_user_id', ondelete='CASCADE'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['resolved_by'], ['User.id'], name=op.f('fi k_feedback_resolved_by_User')),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_feedback_user_id', ondelete='SET NULL'),
    ...
    sa.Column('error_message', sa.String(length=500), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_file_log_user_id', ondelete='SET NULL'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_helath_metric_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_model_usage_logs_user_id', ondelete='CASCADE'),
    ...
    sa.Column('ip_address', sa.String(length=45), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_pass_reset_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_privacy_sett_user_id'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['permission_id'], ['permissions.id'], name='fk_role_permission', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_session_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_sys_log_user_id', ondelete='SET NULL'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['created_by'], ['User.id'], name='fk_tag_user_id'),
    sa.ForeignKeyConstraint(['parent_id'], ['tags.id'], name=op.f('fi k_tags_parent_id_tags')),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_user_pref_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_user_role_user_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user_roles'))
    )
    op.create_index('ix_user_roles_composite', 'user_roles', ['user_id', 'role_id'], unique=True)
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_web_query_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['created_by'], ['User.id'], name='fk_workflow_created_by_user_id'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_device_log_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_feedback_comm_user_id', ondelete='SET NULL'),
    ...
    sa.ForeignKeyConstraint(['assignee_id'], ['User.id'], name='fk_assigned_user_id'),
    sa.ForeignKeyConstraint(['category_id'], ['task_categories.id'], name='fk_task_cat_id'),
    sa.ForeignKeyConstraint(['creator_id'], ['User.id'], name='fk_task_creator_user_id', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_task_user_id', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['uploaded_by'], ['User.id'], name='fk_task_attach_user_id'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['parent_id'], ['task_comments.id'], name=op.f('fi k_task_comments_parent_id_task_comments')),
    sa.ForeignKeyConstraint(['task_id'], ['tasks.id'], name='fk_task_comm_task_id'),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_task_comm_user_id'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='fk_task_hist_user_id', ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.drop_index('ix_user_roles_composite', table_name='user_roles')
    ...
    op.drop_index('ix_users_status', table_name='User')
